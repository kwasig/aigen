    ...
    try:
        ...
        if sandbox.instance.state == WorkspaceState.ARCHIVED or sandbox.instance.state == WorkspaceState.STOPPED:
            ...
            try:
                ...
                await start_supervisord_session(sandbox) # Make this awaitable
...
async def start_supervisord_session(sandbox: Sandbox): # Make async
...
async def create_sandbox(password: str, project_id: str = None): # Make async
